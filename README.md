...
- [opt] Just (for running justfile)
- [opt] Http Client Extension (for endpoint tests)
...
1. Open your web browser and navigate to `http://localhost:PORT` (where PORT is port that is set up in .env file or docker-compose.yaml)
...
[https://short.oooi.dev](https://short.oooi.dev)
